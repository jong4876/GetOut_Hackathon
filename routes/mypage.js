...
.post((req, res)=>{
    ...
    basic_countsql = 'select count(*) as total from Subject where Track_Name rlike ';
    app_countsql = 'select count(*) as total from Subject where Track_Name rlike ';
    basic_mysql = 'select count(*) as total from Fin_Subject where Fin_Student_id = ? and Fin_Subject_id in (select Subject_id from Subject where Track_Name rlike';
    app_mysql = 'select count(*) as total from Fin_Subject where Fin_Student_id = ? and Fin_Subject_id in (select Subject_id from Subject where Track_Name rlike';
                        ...
                        pool.query( app_countsql , function( err, app_count_rows ) {
                            ...
                            pool.query( basic_mysql, inserts, function( err, basic_mysql_rows ) {
                                ...
                                pool.query( app_mysql, inserts, function( err, app_mysql_rows ) {
                                    ...
                                    console.log(appper);
                                    res.render('mypage', { title: 'mypage', track1:rows1, track2:rows2, basic:basicper, app:appper });
                                });
                            });
                        });
                    });
